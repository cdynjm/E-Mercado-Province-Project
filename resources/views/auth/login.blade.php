                  ...
                  <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                     <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('login') }}" data-toggle="validator">
                           ...
                           Don’t have an account? Register now as <a href = '{{route("buyer.signup")}}' id="register" class="text-underline">BUYER</a> | <a href = '{{route("seller.signup")}}' id="register" class="text-underline">SELLER</a>
                           </p>
                        </form>
                     </div>
                  </div>
