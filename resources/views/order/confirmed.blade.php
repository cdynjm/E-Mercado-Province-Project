                                ...
                                @foreach($orders as $order)
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-lg-7 col-sm-8">
                                            ...
                                            <!-- <a href = "{{route('order.place')}}" class = "mb-2 btn btn-danger btn-sm mt-2">CANCEL ORDER</a> -->

                                            <div class = "mt-2  text-sm" style = "font-size: 14px"><i class = "fa fa-map-marker"></i> {!! '<a href = "#" class = "link text-primary">'.$order->seller->street .'</a> / <a href = "#" class = "link text-primary">' . $order->seller->Barangay->brgyDesc .'</a> / <a href = "#" class = "link text-primary">' . ucwords(strtolower($order->seller->Municipality->citymunDesc)) .'</a> / <a href = "#" class = "link text-primary">' . ucwords(strtolower($order->seller->Province->provDesc)) .'</a>' !!}</span></div>
                        ...
                        <div class="card ">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div class="card-body">
                                    ...
                                    <span class = "text-danger small">Visit the seller within 5 days from confirmation, otherwise orders will be cancelled.</span>
                                </div>
                            </div>
                        </div>
                    </div>
