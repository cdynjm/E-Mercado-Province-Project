      ...
      <ul class="navbar-nav ms-auto  navbar-list mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link py-0 d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            @if (auth()->check())
              @if (file_exists('storage/images/client/photo/'.auth()->user()->userProfile->profile_picture))
                <img src="{{asset('storage/images/client/photo/'.auth()->user()->userProfile->profile_picture)}}" alt="User-Profile" class="theme-color-default-img img-fluid avatar avatar-40 avatar-rounded">
              @else
                <img src="{{asset('e-mercado-logo.png')}}" alt="User-Profile" class="theme-color-default-img img-fluid avatar avatar-40 avatar-rounded">
              @endif
            @endif
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="{{route('privacy')}}">Privacy Setting</a></li>
